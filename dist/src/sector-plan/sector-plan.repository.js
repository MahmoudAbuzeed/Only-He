...
exports.SectorPlanRepo = void 0;
const typeorm_1 = require("@nestjs/typeorm");
const common_1 = require("@nestjs/common");
const typeorm_2 = require("typeorm");
const sector_plan_entity_1 = require("./entities/sector-plan.entity");
let SectorPlanRepo = class SectorPlanRepo {
    constructor(sectorPlanRepository) {
        this.sectorPlanRepository = sectorPlanRepository;
    }
    async create(createSectorPlantDto) {
...
SectorPlanRepo = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(sector_plan_entity_1.SectorPlan)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], SectorPlanRepo);
exports.SectorPlanRepo = SectorPlanRepo;
//# sourceMappingURL=sector-plan.repository.js.map