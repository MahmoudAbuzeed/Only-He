...
let SectorService = class SectorService {
    constructor(sectorRepo, errorHandler) {
    ...
    async findAllProjects(sectorId) {
        try {
            const sectors = (await this.sectorRepo.findAllProjects(sectorId));
...
SectorService = __decorate([
    ...
    __metadata("design:paramtypes", [sector_repository_1.SectorRepo,
