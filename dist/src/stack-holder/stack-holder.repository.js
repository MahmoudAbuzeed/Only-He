...
exports.StackHolderRepo = void 0;
const typeorm_1 = require("@nestjs/typeorm");
const common_1 = require("@nestjs/common");
const typeorm_2 = require("typeorm");
const stack_holder_entity_1 = require("./entities/stack-holder.entity");
let StackHolderRepo = class StackHolderRepo {
    constructor(stackHolderRepo) {
...
StackHolderRepo = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(stack_holder_entity_1.StackHolder)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], StackHolderRepo);
exports.StackHolderRepo = StackHolderRepo;
//# sourceMappingURL=stack-holder.repository.js.map