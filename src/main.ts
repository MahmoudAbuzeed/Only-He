...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .setDescription('Comprehensive E-Commerce API for mobile applications with user management, product catalog, shopping cart, orders, and favorites')
    .setVersion('1.0')
    ...
    .addServer('https://api.only-he.com', 'Production server')
    .build();
